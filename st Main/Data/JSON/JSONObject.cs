...
public class JSONObject {
	...
	public void AddField(string name, object o) {
		...
		case "System.Int32":
			AddField (name,Create((int)o));
			break;
		case "System.Single":
			AddField (name,Create((float)o));
			break;
		case "System.Boolean":
			AddField (name,Create((bool)o));
			break;
		case "System.String":
			AddField (name,CreateStringObject((string)o));
			break;
		default:
			AddField (name,CreateStringObject(o.ToString ()));
			break;
		}
	}
